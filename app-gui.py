...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will Capture 300 picture samples of your Face.")
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button4 = tk.Button(self, text="Back to Home Page", command=lambda: self.controller.show_frame("StartPage"), bg="#ffffff", fg="#263942")
